...
test('destinations are lazy fragments instead of simultaneous scene entities', () => {
  ...
  assert.match(dayNight, /minCloudsPerGroup: \{ type: 'int', default: 6 \}/);
  assert.match(dayNight, /maxCloudsPerGroup: \{ type: 'int', default: 12 \}/);
  ...
  assert.match(dayNight, /thickness: size \* this\.randomBetween\(0\.48, 0\.82\)/);
